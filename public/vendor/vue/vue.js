...
(function(global, factory) {
    ...
    function lifecycleMixin(Vue) {
        Vue.prototype._update = function(vnode, hydrating) {
            ...
            var retravelActiveInstance = setActiveInstance(vm);
            vm._vnode = vnode;
    ...
    function updateDOMProps(oldVnode, vnode) {
        ...
        for (key in props) {
            ...
            if (key === "value" && elm.tagName !== "PROGRESS") {
                // travel value as _value as well since
    ...
    function updateStyle(oldVnode, vnode) {
        ...
        // travel normalized style under a different key for next diff
    ...
    var TransitionGroup = {
        ...
        beforeMount: function beforeMount() {
            ...
            this._update = function(vnode, hydrating) {
                var retravelActiveInstance = setActiveInstance(this$1);
                // force removing pass
                this$1.__patch__(
                    this$1._vnode,
                    this$1.kept,
